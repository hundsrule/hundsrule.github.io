        ...
        <div className={`min-h-screen w-full font-sans selection:bg-phantom-red selection:text-white transition-opacity duration-500 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className="fixed top-4 right-4 z-50 flex gap-4">
                ...
                <button 
                    ...
                    className="bg-phantom-black border-2 border-white text-white p-2 hover:bg-white hover:text-phantom-black transition-colors transform hover:scale-110 flex items-center gap-2 font-display"
                >
                    <Globe size={20} />
            ...
            <div className="fixed bottom-4 left-4 z-50 bg-phantom-black border-2 border-white p-2 transform -skew-x-12 hover:scale-110 transition-transform shadow-[4px_4px_0px_0px_rgba(255,255,255,0.5)]">
                <button 
                    onClick={() => {
                        setIsMuted(!isMuted);
                ...
                <audio src="subwebsite/BGM.mp3" autoPlay loop className="hidden" />
            </div>
            ...
            <div className="relative z-10 container mx-auto px-4 py-8 min-h-screen flex flex-col">
                ...
                <header className="text-center mb-12 mt-8">
                    ...
                    <div className="mt-8 max-w-3xl mx-auto bg-phantom-white transform rotate-1 p-6 border-l-8 border-phantom-red shadow-xl">
                ...
                <footer className="mt-auto text-center py-12 border-t-4 border-phantom-red bg-phantom-black text-white relative overflow-hidden">
                     ...
                     <div className="relative z-10 max-w-2xl mx-auto px-4">
                        <div className="mb-8">
                            ...
                            <p className={`text-gray-300 leading-loose ${language === 'cn' ? 'font-sans' : 'font-mono text-sm'}`}>
                                {language === 'en' 
